...
<tr>
    ...
    <td><form action="" method="POST"><input type="hidden" name="id" value=<?php echo $data["NIC_NO"]; ?>> <input type="submit" name="submit" value="Delete" onclick="return confirm('Are you sure you want to delete this user?');"></form></td>
</tr>
<?php
}
?>
